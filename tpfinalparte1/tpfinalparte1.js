//Enlace video youtube: https://youtu.be/HU6xf3oaeC4
...
function draw() {
  //empezamos a dibuhjar la pantallas dependiendo el valor de la variable pantalla nos muestra una imagen u otra
   if (pantalla === 0) {
    ...
    //Funcion donde se unifico el fondo del texto donde se cuenta la historia con el texto
...
//usamos el mouse pressed con condicional if para que en caso de que se cumpla la condicion y se clickeen los botones dependiendo cual use que se realicen la accion correspondiente.

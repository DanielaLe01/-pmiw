class Jugador{ 
  ...
  mover(tecla) {
    //con la letra a nos movemos hacia la izquierda pero solo si el indice de nuestro carril es mayor a 0
    if (tecla === 'a' || tecla === 'A') {
      if (this.indiceCarril > 0) {
        this.indiceCarril--;
      }
    //usando la letra d el personaje seva mover hacia la derecha, pero solo si nuestra variable indiceCarril es menor al tamano de nuestro array -1
